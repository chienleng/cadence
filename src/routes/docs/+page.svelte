<script lang="ts">
	import { Button, Card, CardContent, CardHeader } from '@chienleng/stratum-ui/ui';
</script>
...
<main class="shell docs-shell">
	<section class="hero">
		...
		<p class="lede">
			Cadence is a repository and an opinionated file contract—not an npm package or a hosted
			account.
		</p>
	</section>
	<Card>
